  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Inscrição — Confraternização 2026" },
      {
        ...
        content:
          "Preencha o formulário e confirme sua presença na Confraternização 2026.",
      },
    ],
  }),
  component: Inscricao,
...
const grupos = [
  { value: "sgroup", label: "SGroup Nacional", logo: sgroupLogo.url },
  { value: "solys", label: "Solys Gestão Administrativa", logo: solysLogo.url },
  { value: "grupo_support", label: "Grupo Support", logo: supportLogo.url },
];
        ...
        {done ? (
          <div className="mt-10 rounded-2xl border border-border bg-card p-8 text-center shadow-sm">
            ...
            <p className="mt-2 text-muted-foreground">
              Obrigado, {form.nome_completo.split(" ")[0]}. Nos vemos na
              Confraternização 2026.
            </p>
            <button
              type="button"
